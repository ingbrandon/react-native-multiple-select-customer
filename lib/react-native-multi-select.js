...
export default class MultiSelect extends Component {
  ...
  _getRow = (item) => {
    const { selectedItemIconColor,fontSize,iconSize, displayKey } = this.props;
    return (
      <TouchableOpacity
  ...
  render() {
    const {
      ...
      backgroundCustomerContainer,
      backgroundCustomerInput,
      textColor,
      fixedHeight,
      hideTags,
    } = this.props;
    ...
    return (
      ...
      >
        {
        //Esta parte es cuando el dropdown esta abajo, es decir se muestra los items
        }

        {selector ? (
          <View style={[styles.selectorView(fixedHeight),]}>
            <View style={[styles.inputGroup,{backgroundColor: backgroundCustomerInput }]}>
              <Icon
                name="magnify"
                size={iconSize}
              ...
              {hideSubmitButton && (
                <TouchableOpacity onPress={this._submitSelection}>
                  <Icon
                    ...
                    style={[
                      styles.indicator,
                      { fontSize:iconSize,paddingLeft: 15, paddingRight: 15 },
                    ]}
                  />
                </TouchableOpacity>
              )}
            ...
            <View
              style={{
                flexDirection: 'column',
                backgroundColor: backgroundCustomerContainer,
              }}
            >
          ...
          <View>
            {
            //Esta parte es cuando el dropdown no esta abajo, es decir no se muestra los items
            }
            <View style={[styles.dropdownView]}>
              <View
                style={[
                  styles.subSection,
                  { backgroundColor: backgroundCustomerInput },
                ]}
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      ...
                      style={[styles.indicator,{fontSize:iconSize}]}
                    />
                  </View>
                </TouchableWithoutFeedback>
              </View>
